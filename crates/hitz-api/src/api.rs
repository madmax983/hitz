...
impl VmAction {
    ...
    ///
    /// # Abstract
    /// Provides a present-participle string representation of the action, useful
    /// for logging ongoing operations.
    ///
    /// # The Hero's Journey
    ///
    /// ```rust
    ...
    ///
    /// # Abstract
    /// Provides a past-tense string representation of the action, useful
    /// for logging completed operations.
    ///
    /// # The Hero's Journey
    ///
    /// ```rust
