...
///
/// # Abstract
/// Types implementing this trait can analyze telemetry against a VM's blueprint
/// and return a set of actionable [`ResizeRecommendation`]s to optimize resources.
///
/// ## Examples
///
/// ```rust
