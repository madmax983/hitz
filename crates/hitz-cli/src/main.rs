...
fn draw_vm_top_ui(
    ...
    let header = Paragraph::new(format!("Hitz Top - VM: {}", vm_id))
        ...
        .block(Block::default().borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)));
    f.render_widget(header, main_chunks[0]);

    if let Some(ref err) = last_err {
        let err_p = Paragraph::new(err.as_str())
            .style(Style::default().fg(Color::Red))
            .block(Block::default().borders(Borders::ALL).title("Error").padding(ratatui::widgets::Padding::symmetric(1, 1)));
    ...
    if let Some(ref snap) = last_snap {
        ...
        let cpu_gauge = Gauge::default()
            .block(Block::default().title("CPU").borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)))
        ...
        let mem_gauge = Gauge::default()
            .block(Block::default().title("Memory").borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)))
        ...
        .block(Block::default().title("Disks").borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)));
        ...
        .block(Block::default().title("Networks").borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)));
        ...
        .block(
            Block::default()
                .title("Top Processes")
                .borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)),
        );
        f.render_widget(proc_table, bottom_chunks[1]);
    } else if last_err.is_none() {
        let loading =
            Paragraph::new("Loading metrics...").block(Block::default().borders(Borders::ALL).padding(ratatui::widgets::Padding::symmetric(1, 1)));
