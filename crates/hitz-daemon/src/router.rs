...
{
    // ⚡ Bolt Optimization: Avoid cloning the HTTP method and allocating strings for Uri.
    // We decompose the request to take ownership of the body while borrowing from parts.
